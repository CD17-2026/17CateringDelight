...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (calcApplyBtn && calcPackage && calcGuests) {
    calcApplyBtn.addEventListener('click', () => {
      ...
      window.location.href = `06_event_packages_booking.html?package=${encodeURIComponent(pkgVal)}&guests=${encodeURIComponent(guests)}`;
    });
  }
